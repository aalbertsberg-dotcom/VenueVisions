  ...
  return (
    <main className="page-main shell admin-page chandelier-admin">
      ...
      <section className="owner-quick-grid">
        ...
        <button className="owner-quick-card" onClick={() => onNavigate('messages')}><span>MESSAGES</span><strong>Keep every wedding conversation together</strong><small>Follow the currently selected couple</small><b>→</b></button>
        <button className="owner-quick-card" onClick={() => onNavigate('planner')}><span>2D DESIGNER</span><strong>Build the layout before visualizing it</strong><small>The finished 2D plan becomes the AI Preview input</small><b>→</b></button>
      </section>
