...
export default function Wedding({ venueId, profile, selections, unreadMessages, paymentStepsCompleted, onProfileChange, onNavigate, ownerMode }: WeddingProps) {
  ...
  const eventLabel=venue.eventLabel ?? 'event'; const clientLabel=venue.clientLabel ?? 'client'; const isWedding=eventLabel==='wedding'
  ...
  return <main className="page-main shell wedding-page venue-wedding-page">
    ...
    <div className="wedding-content-grid">
      <section className="panel wedding-details-panel"><div className="panel__heading"><div><p className="eyebrow">{eventLabel.toUpperCase()} DETAILS</p><h2>Plan the {isWedding?'day':'event'}</h2><p>Changes save automatically in this browser preview.</p></div></div><div className="form-grid two-col wedding-detail-fields">
